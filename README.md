...
Currently seeking graduate and entry-level software engineering opportunities in:
- Backend Engineering
- Distributed Systems
...
My pinned repositories showcase a mixture of academic, research, and production-oriented systems projects developed during my time at Trinity College Dublin, KU Leuven (Erasmus), and independent work abroad.
...
- MQTT/TICK-stack powered [RC buggy monitoring system](https://github.com/jmulvany127/RC_Buggy_Stack)
- Information retrieval [search engine implementation](https://github.com/jmulvany127/Lucene_Search_Engine)
- Machine learning projects including [image classification](https://github.com/jmulvany127/ImageClassifer_SemanticSegmentation) and [facial recognition](https://github.com/jmulvany127/Facial_Recognition)
- Security-focused [Capture The Flag project](https://github.com/jmulvany127/CTF-Report)

Always interested in building practical systems and learning new technologies.
